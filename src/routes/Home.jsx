export default function Home() {
  return (
    <div className="flex items-center justify-center min-h-screen lg:h-screen text-white bg-gradient-to-t from-slate-400 to-slate-600">
      <div className="mt-6 mb-6 w-4/6 p-5 text-white rounded-lg sm:w-5/6 bg-slate-600 ">
